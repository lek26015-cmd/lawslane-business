            ...
            <div className="bg-[#0B3979] text-white py-12">
                <div className="container mx-auto px-4 text-center">
                    <h1 className="text-3xl md:text-4xl font-bold mb-4 font-headline">
                        ศูนย์รวมแบบฟอร์มกฎหมาย
                    </h1>
                    <p className="text-blue-100 text-lg max-w-2xl mx-auto">
                        ดาวน์โหลดแบบฟอร์มสัญญาและเอกสารทางกฎหมายที่ถูกต้องตามมาตรฐาน ฟรีสำหรับทุกคน
                    </p>
                </div>
            </div>
                    ...
                    <div className="lg:col-span-6">
                        <div className="mb-6 flex items-center justify-between px-2">
                            <h2 className="text-2xl font-bold text-[#0B3979] font-headline">
                                {selectedCategory === 'ทั้งหมด' ? 'เอกสารทั้งหมด' : selectedCategory}
                            </h2>
                        ...
                        {isLoading ? (
                            ...
                            <div className="text-center py-32 text-slate-500 bg-white rounded-[2.5rem] shadow-sm border border-slate-100 flex flex-col items-center justify-center">
                                ...
                                <p className="text-xl font-semibold text-slate-700 mb-2">ไม่พบแบบฟอร์มที่ค้นหา</p>
                                <p className="text-slate-400">ลองเปลี่ยนคำค้นหาหรือเลือกหมวดหมู่ใหม่</p>
                            </div>
                        ) : (
                            <div className="flex flex-col gap-4">
                                {filteredForms.map(form => {
                                    const hasMultipleFiles = form.attachments && form.attachments.length > 1;
                                            ...
                                            <div className="flex flex-col sm:flex-row items-start sm:items-center p-2">
                                                ...
                                                <div className="flex-1 min-w-0 py-2 px-2 sm:px-0 space-y-1">
                                                    ...
                                                    <p className="text-sm text-slate-500 line-clamp-1 pr-4">
                                                        {form.description || "ไม่มีรายละเอียดเพิ่มเติม"}
                                                    </p>
                                                    ...
                                                    <div className="flex items-center gap-3 text-xs text-slate-400 pt-1">
                                                        <div className="flex items-center gap-1 bg-slate-50 px-2 py-1 rounded-md">
                                                            <span className="uppercase font-semibold text-slate-600">
                                                                {hasMultipleFiles ? `${form.attachments.length} ไฟล์` : fileType}
                                                            </span>
                                                        </div>
                                                        <div className="flex items-center gap-1">
                                                            <Download className="h-3 w-3" />
                                                            <span>{form.downloads || 0} ครั้ง</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    {hasMultipleFiles ? (
                                                        <DropdownMenu>
                                                            <DropdownMenuTrigger asChild>
                                                                <Button className="w-full sm:w-auto bg-[#0B3979] hover:bg-[#082a5a] text-white rounded-xl h-10 font-semibold shadow-md hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300 px-6">
                                                        ...
                                                        <Button
                                                            className="w-full sm:w-auto bg-[#0B3979] hover:bg-[#082a5a] text-white rounded-xl h-10 font-semibold shadow-md hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300 px-6"
                                                            onClick={() => firstFile && handleDownload(form, firstFile)}
                                                            disabled={!firstFile}
                                                        >
                                                            <Download className="mr-2 h-4 w-4" />
                                                            ดาวน์โหลด
                ...
                <DialogContent className="sm:max-w-md">
                    <DialogHeader>
                        <DialogTitle className="flex items-center gap-2 text-xl">
                            ...
                            เข้าสู่ระบบเพื่อดาวน์โหลดต่อ
                        </DialogTitle>
                        <DialogDescription className="pt-2">
                            คุณได้ดาวน์โหลดเอกสารครบ 3 ฉบับสำหรับผู้ใช้งานทั่วไปแล้ว กรุณาเข้าสู่ระบบเพื่อดาวน์โหลดเอกสารเพิ่มเติมได้ไม่จำกัด
                        </DialogDescription>
                    </DialogHeader>
