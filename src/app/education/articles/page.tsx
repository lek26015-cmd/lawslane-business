        ...
        <div className="flex flex-col gap-8">
            ...
            <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    <div>
                        <h1 className="text-3xl font-bold text-slate-900">บทความน่าอ่าน</h1>
                        <p className="text-slate-600 mt-1">รวมบทความกฎหมายที่น่าสนใจสำหรับนักศึกษาและทนายความ</p>
                    </div>
            ...
            {isLoading ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {filteredArticles.map((article) => (
                        <Card key={article.id} className="overflow-hidden h-full flex flex-col group rounded-2xl shadow-sm hover:shadow-lg transition-all">
